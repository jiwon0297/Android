...
public class SendMailAdapter extends BaseAdapter {
    ...
    ArrayList<MailSendListData> sample = null;
    private ServiceApi service;

    private int nlistCnt=0;

    public SendMailAdapter(ArrayList<MailSendListData> _data){
        sample = _data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView oTextRecipient = (TextView) convertView.findViewById(R.id.person);
        ...
        oTextRecipient.setText(sample.get(position).recipient);
