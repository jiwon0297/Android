...
public class SangolActivity extends AppCompatActivity implements ExpandableListView.OnGroupClickListener,
        ExpandableListView.OnChildClickListener{
    ExpandableListView listView;
    String[] groups= new String[]{"2인 이상 주문", "찌개류"};
    String[][] childs={{"제육숙주볶음 7.0","오징어제육 8.0","양푼갈비 7.0","햄짜글이 8.0","돼지파불고기 7.0","김치전골 8.0"},
            {"돼지김치찌개(뚝배기) 7.0","참치김치찌개 7.0","청국장 7.0","차돌된장찌개 7.0","해물된장찌개 7.0"}};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ExpandableListAdapter listAdapter = new SangolActivity.MyExpandableListAdapter();
        ...
        map_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SangolActivity.this, MapFragmentActivity.class);
    ...
    public class MyExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public TextView getGenericView(){
            ...
            TextView textView = new TextView(SangolActivity.this);
