...
public class LikeActivity extends AppCompatActivity implements ExpandableListView.OnGroupClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ExpandableListAdapter listAdapter = new LikeActivity.MyExpandableListAdapter();
        ...
        map_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(LikeActivity.this, MapFragmentActivity.class);
    ...
    public class MyExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public TextView getGenericView(){
            ...
            TextView textView = new TextView(LikeActivity.this);
