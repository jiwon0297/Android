...
public class AfterschoolActivity extends AppCompatActivity implements ExpandableListView.OnGroupClickListener,
        ExpandableListView.OnChildClickListener{
    ExpandableListView listView;
    String[] groups= new String[]{"고기류","식사류","콩불사리추가","주류"};
    String[][] childs={{"대패삼겹살(3인분기준) 3,500원","삼겹살(2인분기준) 5,000원","돼지왕갈비 7,000원","암퇘지 생삼겹살(국내산) 8,000원"},
            {"콩나물불고기+볶음밥 6,000원","치즈콩나물불고기+볶음밥 7,000원","냉면(물/비빔) 4,500원","된장찌개 1,000원","공기밥 1,000원"},
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ExpandableListAdapter listAdapter = new AfterschoolActivity.MyExpandableListAdapter();
        ...
        map_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AfterschoolActivity.this, MapFragmentActivity.class);
