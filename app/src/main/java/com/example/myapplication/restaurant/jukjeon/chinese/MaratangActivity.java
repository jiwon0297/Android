...
public class MaratangActivity extends AppCompatActivity implements ExpandableListView.OnGroupClickListener,
        ExpandableListView.OnChildClickListener{
    ExpandableListView listView;
    String[] groups= new String[]{"메인메뉴","식사류","주류"};
    String[][] childs={{"마라탕 100g 1,600원","마라향궈 100g 2000원","마라빤 100g 2,000원","소고기,양고치(추가 토핑) 3,000원\n꼬치 개당 1,000원\n공기밥(무한리필) 1,000원"},
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ExpandableListAdapter listAdapter = new MaratangActivity.MyExpandableListAdapter();
