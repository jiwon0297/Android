...
public class KalActivity extends AppCompatActivity implements ExpandableListView.OnGroupClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ExpandableListAdapter listAdapter = new KalActivity.MyExpandableListAdapter();
        ...
        map_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(KalActivity.this, MapFragmentActivity.class);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new KalActivity.ItemSelectedListener());
    }
    ...
    public class MyExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public TextView getGenericView(){
            ...
            TextView textView = new TextView(KalActivity.this);
    ...
    class ItemSelectedListener implements BottomNavigationView.OnNavigationItemSelectedListener{
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
            ...
            {
                case R.id.home:
                    Intent intent = new Intent(KalActivity.this, HomeActivity.class);
                    intent.putExtra("NICKNAME_EXTRA", getIntent().getStringExtra("NICKNAME_EXTRA"));
                    startActivity(intent);
                    break;
                case R.id.mail:
                    Intent intent2 = new Intent(KalActivity.this, MailActivity.class);
                    intent2.putExtra("NICKNAME_EXTRA", getIntent().getStringExtra("NICKNAME_EXTRA"));
                    startActivity(intent2);
                    break;
                case R.id.mypage:
                    Intent intent3 = new Intent(KalActivity.this, MypageActivity.class);
