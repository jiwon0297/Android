...
public class ChonActivity extends AppCompatActivity implements ExpandableListView.OnGroupClickListener,
        ExpandableListView.OnChildClickListener{
    ExpandableListView listView;
    String[] groups= new String[]{"유생촌 돈까스 샐러드바","추가요금"};
    String[][] childs={{"스테이크정식 25,800원\n*샐러드바 3인+음료 1잔 포함*","성인 11,900원\n초등학생 8,500원\n미취학(30개월 이상) 5,000원"},
            {"음료&주스 1,000원","생맥주 300cc 2,000원","소주/병맥주 4,000원","도시락포장 7,000원"}};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ExpandableListAdapter listAdapter = new ChonActivity.MyExpandableListAdapter();
        ...
        map_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ChonActivity.this, MapFragmentActivity.class);
    ...
    public class MyExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public TextView getGenericView(){
            ...
            TextView textView = new TextView(ChonActivity.this);
