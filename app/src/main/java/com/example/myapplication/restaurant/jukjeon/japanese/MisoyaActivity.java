...
public class MisoyaActivity extends AppCompatActivity implements ExpandableListView.OnGroupClickListener,
        ExpandableListView.OnChildClickListener{
    ExpandableListView listView;
    String[] groups= new String[]{"돈카츠", "우동","기타"};
    String[][] childs={{"로스카츠 8,000원","히레카츠 9,000원","옛날식 달콤한 로스카츠 9,500원","고구마 치즈 돈카츠 9,500원","매콤철판돈카츠 9,500원"},
            {"돈카츠김치우동전골 8,500원","우삼겹우동전골 8,500원","돈카츠야끼우동 8,000원"},
            {"알밥정식 8,500원","치킨데리야끼벤토 7,500원","카츠모밀 알밥정식 9,000원","냉모밀 6,500원"}};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ExpandableListAdapter listAdapter = new MisoyaActivity.MyExpandableListAdapter();
        ...
        map_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MisoyaActivity.this, MapFragmentActivity.class);
    ...
    public class MyExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public TextView getGenericView(){
            ...
            TextView textView = new TextView(MisoyaActivity.this);
