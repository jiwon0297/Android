...
public class HouseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView parent, View v, int position, long id){
                Intent intent = new Intent(HouseActivity.this, MateViewActivity.class);
    ...
    public void InitializeDataList()
    {
        ...
        DataList.add(new SampleData("기숙사 같이 사실 분 구해요.", "배정원","2020-05-27 오전 11:55"));
        DataList.add(new SampleData("여기 근처에 자리 남은 쉐어하우스 있나요?", "이승미","2020-05-26 오전 11:55"));
        DataList.add(new SampleData("투룸 하우스메이트 구합니다.", "김진하","2020-05-27 오후 02:55"));
    }
